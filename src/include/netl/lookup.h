...
#ifndef NETL_LOOKUP_H
#define NETL_LOOKUP_H
...
extern struct lookupitem netl_table_icmptype[MAXICMPTYPE];
#define icmptype netl_table_icmptype
extern struct lookupitem netl_table_icmp6type[MAXICMP6TYPE];
#define icmp6type netl_table_icmp6type
extern struct lookupitem netl_table_icmpcode[MAXICMPCODE];
#define icmpcode netl_table_icmpcode
