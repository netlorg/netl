...
/*==============================================================================
| for config.c
| + tables for the ICMP protocol.
==============================================================================*/

struct lookupitem netl_table_icmptype[MAXICMPTYPE] = 
...
struct lookupitem netl_table_icmp6type[MAXICMP6TYPE] = {
...
struct lookupitem netl_table_icmpcode[MAXICMPCODE] =
