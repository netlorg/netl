...
int netl_config_resolveHostnames=TRUE;
...
char *
netl_resolve_addip(const char *s, u32 ip)
{
	listtype	*tmp;
	int		len;
...
u32
netl_resolve_searchbyname(char *name) 
{
	listtype *tmp;
